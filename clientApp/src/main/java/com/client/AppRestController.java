...
public class AppRestController {
    ...
    public RedirectView processForm1() {
        ...
        String url = "https://tharika.auth0.com/authorize"+
                    "?audience=https://tharika.auth0.com/api/v2/"+
                    "&scope=openid%20profile"+
                    "&response_type=code"+
                    "&client_id=lEAIIbfhnSV4dL9tfUz9X2ECn9o7C84k"+
    ...
    public String getAuthResponse(String authCode)
    {
        ...
        String POST_PARAMS = "grant_type=authorization_code"+
                            "&client_id=lEAIIbfhnSV4dL9tfUz9X2ECn9o7C84k"+
                            "&client_secret=0KQhLxYsYoUvEwfouXX9zKfhAbHl83zXpJFDiDw8kqLmrMqysXwrujEidEJdbHGW"+
                            "&code="+authCode+
                            "&redirect_uri=http%3A%2F%2Flocalhost%3A9999%2Foauth%2Faccess";
        String authReponse = "";
